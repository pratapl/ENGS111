...
for i = 1:4
    ...
    %rice.png
    imageSequence1(:,:,1,i) = topBottomHat(imIn1,SE,0); %bottomHat
    imageSequence1(:,:,1,i+4) = topBottomHat(imIn1,SE,1); %topHat
    
    %son1-1.gif
    imageSequence2(:,:,1,i) = topBottomHat(imIn2,SE,0); %bottomHat
    imageSequence2(:,:,1,i+4) = topBottomHat(imIn2,SE,1); %topHat
